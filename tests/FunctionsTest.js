  ...
  it("Sorting players of team in descending order of awards won", function () {
    let expectedResult = [
      ...
      },
      {
        ...
        url: "https://media.guim.co.uk/facf1f1a9a6679715927fa622d63d6659b411ef8/67_447_3931_2359/500.jpg",
        awards: [
          { name: "FIFA FIFPro World XI", year: 2017 },
          { name: "Footballer of the Year in Germany", year: 2018 },
        ],
      },
      {
        name: "Raphaël Varane",
        ...
        country: "France",
        url: "https://media.guim.co.uk/ca6b3b683136f68e87631092cc5fd5fbf809bc0d/83_565_3451_2071/500.jpg",
        awards: [{ name: "FIFA FIFPro World XI", year: 2018 }],
      },
      {
        name: "Sergio Ramos",
        age: 32,
        ...
        country: "Spain",
        url: "https://media.guim.co.uk/abdacdfe6cd56d03d49b7851926ceeab4f8a9314/176_128_2651_1591/500.jpg",
        awards: [{ name: "FIFA FIFPro World XI", year: 2019 }],
      },
      {
        name: "Marcelo",
        age: 30,
...
describe("Sort player's names in alphabetical order  who have won certain awards certain times - FilterByTeamxSortByNoOfAwards", function () {
  ...
  it("Sort players name alphabetical order of names who have won certain awards certain times", function () {
    let expectedResult = [
      {
        ...
        url: "https://media.guim.co.uk/2b6caa5d916bf2936e054f7294f020a500caa0fa/187_230_2734_1641/500.jpg",
        awards: [
          { name: "FIFA Puskás Award", year: 2012 },
          { name: "FIFA FIFPro World XI", year: 2017 },
          { name: "Samba Gold", year: 2017 },
        ],
      },
      {
        name: "Marcelo",
    ...
    let actualResult = SortByNamexAwardxTimes(
    ...
    let expectedResult = [
      {
        ...
        awards: [
          { name: "Ballon", year: 2018 },
          { name: "The Best FIFA Men's Player", year: 2017 },
      ...
      },
      {
        ...
        country: "Spain",
        url: "https://media.guim.co.uk/cf0a8b9a85d5cab6f42e5a7172a056b2a2aff541/0_560_4618_2771/500.jpg",
        awards: [{ name: "PFA Premier League Team of the Year", year: 2014 }],
      },
      {
        name: "Luka Modric",
        age: 33,
